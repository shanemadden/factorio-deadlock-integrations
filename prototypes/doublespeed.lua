...
if data.raw.loader["ultra-fast-belt-loader"] then
	data.raw.loader["ultra-fast-belt-loader"].speed = data.raw["transport-belt"]["ultra-fast-belt"].speed
end
...
if data.raw.loader["extreme-fast-belt-loader"] then
	data.raw.loader["extreme-fast-belt-loader"].speed = data.raw["transport-belt"]["extreme-fast-belt"].speed
end
...
if data.raw.loader["ultra-express-belt-loader"] then
	data.raw.loader["ultra-express-belt-loader"].speed = data.raw["transport-belt"]["ultra-express-belt"].speed
end
...
if data.raw.loader["extreme-express-belt-loader"] then
	data.raw.loader["extreme-express-belt-loader"].speed = data.raw["transport-belt"]["extreme-express-belt"].speed
end
...
if data.raw.loader["ultimate-belt-loader"] then
	data.raw.loader["ultimate-belt-loader"].speed = data.raw["transport-belt"]["ultimate-belt"].speed
end
